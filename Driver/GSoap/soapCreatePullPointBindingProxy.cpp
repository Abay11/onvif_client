...
{
	struct __name7__CreatePullPoint soap_tmp___name7__CreatePullPoint;
	if (soap_endpoint_url != NULL)
		soap_endpoint = soap_endpoint_url;
	if (soap_action == NULL)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/CreatePullPoint/CreatePullPointRequest";
	soap_tmp___name7__CreatePullPoint.wsnt__CreatePullPoint = wsnt__CreatePullPoint;
	soap_begin(soap);
	soap_set_version(soap, 2); /* use SOAP1.2 */
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___name7__CreatePullPoint(soap, &soap_tmp___name7__CreatePullPoint);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___name7__CreatePullPoint(soap, &soap_tmp___name7__CreatePullPoint, "-name7:CreatePullPoint", "")
