...
{
	struct __name4__Subscribe soap_tmp___name4__Subscribe;
	if (soap_endpoint_url != NULL)
		soap_endpoint = soap_endpoint_url;
	if (soap_action == NULL)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/NotificationProducer/SubscribeRequest";
	soap_tmp___name4__Subscribe.wsnt__Subscribe = wsnt__Subscribe;
	soap_begin(soap);
	soap_set_version(soap, 2); /* use SOAP1.2 */
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___name4__Subscribe(soap, &soap_tmp___name4__Subscribe);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___name4__Subscribe(soap, &soap_tmp___name4__Subscribe, "-name4:Subscribe", "")
...
{
	struct __name4__GetCurrentMessage soap_tmp___name4__GetCurrentMessage;
	if (soap_endpoint_url != NULL)
		soap_endpoint = soap_endpoint_url;
	if (soap_action == NULL)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/NotificationProducer/GetCurrentMessageRequest";
	soap_tmp___name4__GetCurrentMessage.wsnt__GetCurrentMessage = wsnt__GetCurrentMessage;
	soap_begin(soap);
	soap_set_version(soap, 2); /* use SOAP1.2 */
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___name4__GetCurrentMessage(soap, &soap_tmp___name4__GetCurrentMessage);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___name4__GetCurrentMessage(soap, &soap_tmp___name4__GetCurrentMessage, "-name4:GetCurrentMessage", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
